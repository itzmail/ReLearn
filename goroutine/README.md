...
> Kalau kita ingin menggunakan satu kali dengan waktu delay pakai `timer` kalau ingin dipakai berkali-kali dengan waktu delay pakai `time.Ticker` atau `time.Tick`
