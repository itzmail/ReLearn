...
/*
	...
	* Artinya, jika kita mengirim sebuah variable ke dalam function, method atau variable lain, sebenarnya yang dikirim adalah duplikasi valuenya Jadi tidak mengubah value asal
...
func main() {
	address1 := Address{City: "Subang", Province: "West Java", Country: "Indonesia"}
	var address2 *Address = &address1

	// menggunakan pointer
	address3 := &address1             // cara 1
	var address4 *Address = &address1 // cara 2 * itu tipe data pointer
